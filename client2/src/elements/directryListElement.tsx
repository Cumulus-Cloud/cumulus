...
class FileListElement extends React.Component<PropsWithStyle, State> {
  ...
  render() {
    ...
    const icon =
      this.state.selected ?
        <Icon onClick={() => this.select()} color="primary" >folder</Icon> :
        <Icon onClick={() => this.select()} >folder</Icon>

    const title = 
      this.state.selected ?
        <Typography onClick={() => this.select()} color="primary" className={this.props.classes.headingSelected}>{this.props.name}</Typography> :
        <Typography onClick={() => this.select()} className={this.props.classes.heading}>{this.props.name}</Typography>
