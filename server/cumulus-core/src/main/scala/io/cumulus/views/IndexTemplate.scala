...
import scalatags.Text.all.{Tag, attr, body, charset, div, head, href, html, id, link, media, meta, name, raw, rel, script, src, style, tag, tpe}
...
trait IndexTemplate extends View {
  ...
  def langMessages: LangMessages

  protected val pageTitle: String =
    langMessages("view.title")
