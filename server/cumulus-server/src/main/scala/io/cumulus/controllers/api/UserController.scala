...
import io.cumulus.services.{EventService, SessionService, TokenService, UserService}
...
class UserController (
  ...
  val auth: controllers.utils.Authenticator[AuthenticationToken, UserSession]
)(implicit
  val m: Messages,
