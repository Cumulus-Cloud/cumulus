...
export default function LockCloseIcon({ className, color = "#3DC7BE", width = 20, height = 20 }: Props) {
  return (
    <svg className={className} fill={color} width={width} height={height} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path
